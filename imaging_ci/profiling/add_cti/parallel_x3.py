...
dataset_file = "pre_cti_data_0_100.fits"
...
image = ac.Array2D.from_fits(
    file_path=path.join(dataset_path, dataset_file), hdu=0, pixel_scales=0.1
)
...
clocker.add_cti(
    data=image.native, parallel_trap_list=parallel_trap_list, parallel_ccd=parallel_ccd
)
...
clocker = ac.Clocker2D(
    ...
    parallel_fast_pixels=(1, total_columns - 1),
)
